...
var require_FileExtensions1ToIcon = __commonJS({
  "node_modules/vscode-icons-js/dist/generated/FileExtensions1ToIcon.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FileExtensions1ToIcon = void 0;
    exports2.FileExtensions1ToIcon = {
...
var require_FileExtensions2ToIcon = __commonJS({
  "node_modules/vscode-icons-js/dist/generated/FileExtensions2ToIcon.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FileExtensions2ToIcon = void 0;
    exports2.FileExtensions2ToIcon = {
...
var require_FileNamesToIcon = __commonJS({
  "node_modules/vscode-icons-js/dist/generated/FileNamesToIcon.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FileNamesToIcon = void 0;
    exports2.FileNamesToIcon = {
...
var require_FolderNamesToIcon = __commonJS({
  "node_modules/vscode-icons-js/dist/generated/FolderNamesToIcon.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FolderNamesToIcon = void 0;
    exports2.FolderNamesToIcon = {
...
var require_LanguagesToIcon = __commonJS({
  "node_modules/vscode-icons-js/dist/generated/LanguagesToIcon.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.LanguagesToIcon = void 0;
    exports2.LanguagesToIcon = {
...
var require_Index = __commonJS({
  "node_modules/vscode-icons-js/dist/Index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getIconForOpenFolder = exports2.getIconForFile = exports2.getIconForFolder = exports2.DEFAULT_FILE = exports2.DEFAULT_ROOT_OPENED = exports2.DEFAULT_ROOT = exports2.DEFAULT_FOLDER_OPENED = exports2.DEFAULT_FOLDER = void 0;
    ...
    exports2.DEFAULT_FOLDER = "default_folder.svg";
    exports2.DEFAULT_FOLDER_OPENED = "default_folder_opened.svg";
    exports2.DEFAULT_ROOT = "default_root_folder.svg";
    exports2.DEFAULT_ROOT_OPENED = "default_root_folder_opened.svg";
    exports2.DEFAULT_FILE = "default_file.svg";
    function getIconForFolder(folderName) {
      var folderIcon = FolderNamesToIcon_1.FolderNamesToIcon[folderName];
      return folderIcon ? folderIcon : exports2.DEFAULT_FOLDER;
    }
    exports2.getIconForFolder = getIconForFolder;
    ...
    exports2.getIconForFile = getIconForFile;
    function getIconForOpenFolder(folderName) {
      return getIconForFolder(folderName).split(".").shift() + "_opened.svg";
    }
    exports2.getIconForOpenFolder = getIconForOpenFolder;
  }
});

// electron/main/index.js
var { app, BrowserWindow, ipcMain, dialog, Menu, shell } = require("electron");
...
var EXTENSIONS_FILE = path.join(app.getPath("userData"), "browser-extensions.json");
var readExtensions = () => {
  try {
    return JSON.parse(fs.readFileSync(EXTENSIONS_FILE, "utf8"));
  } catch {
    return [];
  }
};
var writeExtensions = (d) => {
  try {
    fs.writeFileSync(EXTENSIONS_FILE, JSON.stringify(d, null, 2));
    return true;
  } catch {
    return false;
  }
...
var _availableEditors = null;
var getAvailableEditors = () => {
  if (_availableEditors) return _availableEditors;
  const cmdExists = (cmd) => {
    try {
      require("child_process").execSync(process.platform === "win32" ? `where ${cmd}` : `which ${cmd}`, { stdio: "ignore" });
      return true;
    } catch {
      return false;
    }
  };
  _availableEditors = KNOWN_EDITORS.filter((e) => e.id !== "system" && e.commands.some(cmdExists)).map((e) => ({ id: e.id, label: e.label }));
...
ipcMain.handle("fs:openFile", async (_e, { filePath, editorId }) => {
  ...
  try {
    require("child_process").spawn(editor.commands[0], [filePath], { detached: true, stdio: "ignore" }).unref();
  } catch {
    await shell.openPath(filePath);
  }
});
...
var sortByName = (arr) => arr.sort((a, b) => a.name.localeCompare(b.name, void 0, { sensitivity: "base" }));
ipcMain.handle("fs:readDir", async (_e, dirPath) => {
  try {
    return sortByName(fs.readdirSync(toLongPath(dirPath), { withFileTypes: true }).filter((e) => e.isDirectory()).map((e) => ({ name: e.name, path: path.join(dirPath, e.name) })));
  } catch {
    return [];
  }
});
...
var PIN_DIR = ".project_config";
var PIN_FILE = ".pinconfig";
...
ipcMain.handle("fs:newFolder", async (_e, { parentPath, name }) => {
  ...
  return path.join(parentPath, path.basename(final));
});
...
ipcMain.handle("fs:rename", async (_e, { oldPath, newName }) => {
  ...
  try {
    ...
    throw new Error(`Cannot rename "${path.basename(oldPath)}": ${err.code === "EBUSY" ? "file is in use by another process" : err.message}`);
  }
});
...
function readManifest(rootPath) {
  try {
    return JSON.parse(fs.readFileSync(manifestPath(rootPath), "utf8"));
  } catch {
    return {};
  }
}
...
ipcMain.handle("fs:duplicate", async (_e, { itemPath }) => {
  ...
  try {
    ...
    const s = fs.statSync(lp);
    if (s.isDirectory()) fs.cpSync(lp, dest, { recursive: true });
    else fs.copyFileSync(lp, dest);
...
ipcMain.handle("fs:copyItem", async (_e, { srcPath, destDir }) => {
  ...
  try {
    ...
    if (s.isDirectory()) fs.cpSync(lpSrc, dest, { recursive: true });
    else fs.copyFileSync(lpSrc, dest);
...
ipcMain.handle("fs:stat", async (_e, itemPath) => {
  try {
    const s = fs.statSync(toLongPath(itemPath));
    return { isDir: s.isDirectory(), exists: true };
  } catch {
    return { isDir: false, exists: false };
  }
});
var vsicons = require_Index();
var VSICONS_B = "https://raw.githubusercontent.com/vscode-icons/vscode-icons/master/icons/";
ipcMain.handle("fs:getVscodeIcon", (_e, { name, isDir, isOpen }) => {
  try {
    return VSICONS_B + (isDir ? isOpen ? vsicons.getIconForOpenFolder(name) : vsicons.getIconForFolder(name) : vsicons.getIconForFile(name));
  } catch {
    return VSICONS_B + (isDir ? "default_folder.svg" : "default_file.svg");
  }
});
...
ipcMain.handle("fs:readTextFile", async (_e, filePath) => {
  try {
    return fs.readFileSync(toLongPath(filePath), "utf8");
  } catch {
    return null;
  }
});
ipcMain.handle("fs:readFileAsDataUrl", async (_e, filePath) => {
  try {
    ...
    const mime = ext === ".svg" ? "image/svg+xml" : ext === ".ico" ? "image/x-icon" : ext === ".png" || ext === ".jpg" || ext === ".jpeg" || ext === ".gif" || ext === ".bmp" || ext === ".webp" ? `image/${ext.slice(1)}` : ext === ".mp4" ? "video/mp4" : ext === ".webm" ? "video/webm" : null;
    if (!mime) return null;
...
function watcherKey(rootPath, wcId) {
  return `${rootPath}::${wcId}`;
}
...
ipcMain.handle("fs:watch", (event, rootPath) => {
  ...
  const watcher = chokidar.watch(rootPath, {
    depth: 3,
    // only watch 3 levels deep initially; shallow is cheap
    ignoreInitial: true,
    ...
    persistent: true,
    usePolling: false,
    // use native OS events, no polling
    awaitWriteFinish: { stabilityThreshold: 100, pollInterval: 50 }
  });
  const notify = (changedPath) => {
    const affectedDir = fs.existsSync(changedPath) && fs.statSync(changedPath).isDirectory() ? changedPath : path.dirname(changedPath);
...
var termProcesses = /* @__PURE__ */ new Map();
var lastProjectPath = null;
function detectShell() {
  if (process.platform !== "win32") return process.env.SHELL || "/bin/bash";
  try {
    require("child_process").execSync("pwsh -c exit", { stdio: "ignore" });
    return "pwsh.exe";
  } catch {
  }
  try {
    require("child_process").execSync("powershell -c exit", { stdio: "ignore" });
...
function getShellArgs(shell2) {
  if (shell2 === "pwsh.exe" || shell2 === "powershell.exe") return ["-NoLogo"];
  return [];
}
function termKey(sender, tabId) {
  return `${sender.id}:${tabId}`;
}
...
ipcMain.handle("terminal:open", async (event, { tabId, cwd }) => {
  ...
  const shellArgs = getShellArgs(shell2);
  const p = pty.spawn(shell2, shellArgs, {
    name: "xterm-256color",
    cols: 80,
    rows: 24,
    cwd: cwd || process.cwd(),
  ...
  p.onData((data) => {
    try {
      event.sender.send("terminal:data", { tabId, data });
    } catch {
    }
  });
  p.onExit(({ exitCode, signal }) => {
    ...
    try {
      event.sender.send("terminal:exit", { tabId, code: exitCode, signal });
    } catch {
    }
  });
  return true;
...
var COMMON_PORTS = [3e3, 3001, 5e3, 5173, 8080, 8081, 4200, 8e3, 3005, 3006];
function scanPorts() {
  return new Promise((resolve) => {
    const active = [];
    ...
    for (const port of COMMON_PORTS) {
      let checkDone2 = function() {
        if (--remaining <= 0) resolve(active.sort((a, b) => a - b));
      };
      var checkDone = checkDone2;
...
var pendingNativeDragPaths = null;
ipcMain.on("drag:startNative", (event, paths) => {
  pendingNativeDragPaths = paths;
  event.returnValue = true;
});
var sendToRenderer = (channel, payload) => {
  const win = BrowserWindow.getFocusedWindow() || BrowserWindow.getAllWindows()[0];
  if (win) win.webContents.send(channel, payload);
};
var SESSION_FILE = path.join(app.getPath("userData"), "session.json");
      ...
      submenu: [
        { label: "Open Project", accelerator: "CmdOrCtrl+O", click: async () => {
          ...
          if (!r.canceled && r.filePaths.length) {
            lastProjectPath = r.filePaths[0];
            sendToRenderer("menu:openProject", r.filePaths[0]);
          }
        } },
        { label: "New Project", accelerator: "CmdOrCtrl+Shift+N", click: async () => {
          const r = await dialog.showOpenDialog({ title: "Select folder for new project", properties: ["openDirectory", "createDirectory"] });
          if (!r.canceled && r.filePaths.length) {
            lastProjectPath = r.filePaths[0];
            sendToRenderer("menu:newProject", r.filePaths[0]);
          }
        } },
        { type: "separator" },
        { label: "Save Project", accelerator: "CmdOrCtrl+S", click: () => sendToRenderer("menu:saveProject", null) },
        { type: "separator" },
        { label: "Close Project", accelerator: "CmdOrCtrl+W", click: () => {
...
function createWindow() {
  ...
  win.on("close", async () => {
    try {
      ...
      let layout = null;
      try {
        layout = await win.webContents.executeJavaScript("window.__getLayoutJSON()");
      } catch {
      }
      const data = {
